...
const Home1Testimonail = () => {
  ...
  return (
    <div className="testimonial-section testimonials-orange">
      ...
      <style jsx>{`
        .testimonials-orange :global(.section-title h2) {
          color: #000;
          font-weight: 700;
          margin-bottom: 12px;
        }
        .testimonials-orange :global(.section-title span) {
          color: #f6a824;
          margin-bottom: 0;
        }
        .testimonials-orange :global(.section-title span svg) {
          fill: #f6a824;
        }
        .testimonials-orange :global(.nav-pills) {
          flex-wrap: wrap;
          justify-content: center;
          row-gap: 6px;
        }
        .testimonials-orange :global(.nav-link.active) {
          color: #f6a824;
        }
        .testimonials-orange :global(.nav-link.active::before) {
          background-color: #f6a824;
        }
        .testimonials-orange :global(.rating li i) {
          color: #f6a824 !important;
        }
        .testimonials-orange :global(.slider-btn) {
          border-color: #f6a824;
        }
        .testimonials-orange :global(.slider-btn svg) {
          fill: #f6a824;
        }
        .testimonials-orange :global(.slider-btn:hover) {
          background-color: #f6a824;
        }
        .testimonials-orange :global(.slider-btn:hover svg) {
          fill: #fff;
        }
        @media (max-width: 767px) {
          .testimonials-orange :global(.nav-pills .nav-item) {
            padding: 0 12px;
          }
          .testimonials-orange :global(.testimonial-card-slider-area) {
            padding: 0;
          }
        }
        @media (max-width: 575px) {
          ...
          .testimonials-orange :global(.nav-link) {
            font-size: 13px;
            height: auto;
            min-height: 40px;
          }
